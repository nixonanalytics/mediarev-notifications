...
const layout = `<div class='article shadow_secondary Z7rPmDxqE9F5ybL3'><h2>{TITLE}</h2><p>{SUMMARY}</p><a href='{URL}' class='button btn-gradient' target='_blank'>See More</a></div>`;
